...
export default function CategorySingleScreen({ navigation, category, mynextUrl, myproducts, product }) {
                ...
                <FlatList
                    ...
                    renderItem={({ item, }) => {
                        return <View style={{ marginTop: 30 }}>
                            ...
                            <TouchableOpacity style={{ flexDirection: 'row', marginTop: 10 }} onPress={navToPageTwo}>
                                <Image
