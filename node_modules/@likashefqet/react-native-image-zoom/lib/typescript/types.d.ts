import type { ActivityIndicatorProps, ImageProps, ImageSourcePropType, StyleProp, ViewStyle } from 'react-native';
export declare type ImageZoomProps = Omit<ImageProps, 'source'> & {
    /**
